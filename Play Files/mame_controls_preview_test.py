...
class PreviewWindow(QMainWindow):
    ...
    def get_button_prefix_from_mapping(self, mapping):
        ...
        # NEW - DirectInput mappings
        dinput_to_prefix = {
            # Standard buttons (PS5-style controller)
            "DINPUT_1_BUTTON1": "□",      # Square
            "DINPUT_1_BUTTON2": "×",      # Cross
            "DINPUT_1_BUTTON3": "○",      # Circle
            "DINPUT_1_BUTTON4": "△",      # Triangle
            "DINPUT_1_BUTTON5": "L1",     # Left shoulder
            "DINPUT_1_BUTTON6": "R1",     # Right shoulder
            "DINPUT_1_BUTTON7": "L2",     # Left trigger
            "DINPUT_1_BUTTON8": "R2",     # Right trigger
            "DINPUT_1_BUTTON9": "Share",  # Create/Share button
            "DINPUT_1_BUTTON10": "Opt",   # Options button
            "DINPUT_1_BUTTON11": "L3",    # Left stick button
            "DINPUT_1_BUTTON12": "R3",    # Right stick button
            
            # D-pad
            "DINPUT_1_POV1_UP": "D↑",
            "DINPUT_1_POV1_DOWN": "D↓",
            "DINPUT_1_POV1_LEFT": "D←",
            "DINPUT_1_POV1_RIGHT": "D→",
            
            # Analog sticks
            "DINPUT_1_AXIS1_NEG": "L←",   # Left stick left
            "DINPUT_1_AXIS1_POS": "L→",   # Left stick right
            "DINPUT_1_AXIS2_NEG": "L↑",   # Left stick up
            "DINPUT_1_AXIS2_POS": "L↓",   # Left stick down
            "DINPUT_1_AXIS3_NEG": "R←",   # Right stick left
            "DINPUT_1_AXIS3_POS": "R→",   # Right stick right
            "DINPUT_1_AXIS4_NEG": "R↑",   # Right stick up
            "DINPUT_1_AXIS4_POS": "R↓",   # Right stick down
        ...
        # Combine mapping dictionaries - include dinput_to_prefix
        all_mappings = {**xinput_to_prefix, **dinput_to_prefix, **mame_to_prefix, **keyboard_to_prefix}
        ...
        # NEW - Add partial matching for DINPUT buttons
        if "DINPUT_1_BUTTON" in mapping:
            try:
                # Extract button number
                button_num = int(mapping.replace("DINPUT_1_BUTTON", ""))
                if button_num <= 12:
                    # Use PS5-style button names
                    ps5_buttons = ["", "□", "×", "○", "△", "L1", "R1", "L2", "R2", "Share", "Opt", "L3", "R3"]
                    if button_num < len(ps5_buttons):
                        return ps5_buttons[button_num]
                    else:
                        return f"B{button_num}"
            except:
                pass
