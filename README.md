...
This will create a `dist/preview` directory containing the executable and all necessary files. Copy the contents fo the preview fodler to your MAME directory, and run the executable.
