...
from mame_data_utils import (
    ...
    convert_mapping, extract_keycode_from_mapping, format_keycode_display,
...
class MAMEControlConfig(ctk.CTk):
    ...
    def extract_keycode_from_mapping(self, mapping: str) -> str:
        ...
        if " OR " in mapping:
            ...
            for part in parts:
                ...
                if part.startswith('KEYCODE_'):
                    result = format_keycode_display(part)
        ...
        if mapping.startswith('KEYCODE_'):
            result = format_keycode_display(mapping)
        ...
        if self.input_mode == 'xinput':
            ...
            if "JOYCODE" in mapping:
                ...
                if "JOYCODE" in converted:
                    ...
                    return format_mapping_display(converted)
